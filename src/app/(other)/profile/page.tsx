...
export default function Checkout() {
    ...
    const currentOrders: any[] = component === "Orders" ? orders.slice(indexOfFirstOrder, indexOfLastOrder) : component === "Wishlist" ? wishlist?.slice(indexOfFirstOrder, indexOfLastOrder) : [];
    ...
    useEffect(() => {
        session && component === "Orders" ? setLength(orders.length) : component === "Wishlist" ? setLength(wishlist.length) : setLength(0)
    }, [session, orders, wishlist, component])
